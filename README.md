...
You can use any standard C++ compiler to compile your code. We recommend using `clang++`. 

```
clang++ -std=c++20 -pedantic-errors -O3 main.cpp student_code_1.cpp -o main
```
************************
